...
//notesssssssssssssssssssssssssssssssSSSSSSSSSSSSSSSS5555555556%%%%%%%%%%&&&&&&&((((((((()))))))))
function authUser(req, res, next) {
  console.log('inside auth userrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr')
  try {
    const token = req.body._token || req.query._token;
    if (token) {
      //changed from decode to verify
      let payload = jwt.verify(token, SECRET_KEY);
      console.log(payload, 'payload@@@@@@@@@22222222222222222222222222222222222222222222222222222@@@')
