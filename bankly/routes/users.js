...
router.patch('/:username', authUser, requireLogin, requireAdmin, async function(
  ...
  try {
    ...
    //very cheeky
    //if usernames dont match and its not an admin then another user is trying to get,
    //an admin name does not matche but admin is true so he can access it
    // this blocks a user who is not admin nor correct user
    ...
    console.log(user, 'userrrrrrrrrrssssssssssssssrssssssssssssssssssssssss')
    return res.json({ user });
  } catch (err) {
    return next(err);
  }
